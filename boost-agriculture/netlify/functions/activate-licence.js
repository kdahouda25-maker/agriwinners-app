// Fonction serveur Netlify — active une clé de licence Boost Agriculture auprès de Chariow.
...
function traduireErreur(msg) {
  ...
  if (/revoked/i.test(msg)) return "Cette clé a été désactivée. Contactez le support Boost Agriculture.";
  if (/expired/i.test(msg)) return "Cette clé a expiré. Contactez le support Boost Agriculture.";
